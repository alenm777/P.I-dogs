...
export const Paginate = ({pagina, setPagina, maximo}) => {
  ...
  return (
    <div className={styles.container}>
      <button className={styles.button} disabled={pagina === 1 || pagina < 1} onClick={previousPage}>
        <svg className={styles.svg} viewBox="0 0 20 27" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <input
        ...
        value={input}
      />
      <p className={styles.p}> de {maximo} </p>
      <button
